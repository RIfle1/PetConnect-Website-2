...
<body>
    ...
    <div id="cs-form-body" class="text-font-500">
        <lien><a href="profile.php">Compte</a>><a id="actif" href="">Connexion et sécurité</a></lien>
        <div id="cs-form-body-div">
            <div class="cs-form-elem">
                <h1><?php echo $languageList["Connection and Security"] ?></h1>
            </div>
            <!--        Username-->
            <div class="cs-form-elem">
                <div class="cs-form-elem-content">
                    ...
                    <?php if (isset($loggedIn) && isset($entityAttributes) && isset($entityInfo)) : ?>
                        <span id="cs-form-info-span-username"><?php if ($loggedIn) {
                                                                    echo $entityInfo[$entityAttributes['Username']];
                                                                } ?></span>
                    <?php endif; ?>
            ...
            <div class="cs-form-elem">
                <div class="cs-form-elem-content">
                    ...
                    <?php if (isset($loggedIn) && isset($entityAttributes) && isset($entityInfo)) : ?>
                        <span id="cs-form-info-span-firstName"><?php if ($loggedIn) {
                                                                    echo $entityInfo[$entityAttributes["FirstName"]];
                                                                } ?></span>
                    <?php endif; ?>
            ...
            <div class="cs-form-elem">
                <div class="cs-form-elem-content">
                    ...
                    <?php if (isset($loggedIn) && isset($entityAttributes) && isset($entityInfo)) : ?>
                        <span id="cs-form-info-span-lastName"><?php if ($loggedIn) {
                                                                    echo $entityInfo[$entityAttributes['LastName']];
                                                                } ?></span>
                    <?php endif; ?>
            ...
            <div class="cs-form-elem">
                <div class="cs-form-elem-content">
                    ...
                    <?php if (isset($loggedIn) && isset($entityAttributes) && isset($entityInfo)) : ?>
                        <span id="cs-form-info-span-phoneNumber"><?php if ($loggedIn) {
                                                                        echo $entityInfo[$entityAttributes["PhoneNumber"]];
                                                                    } ?></span>
                    <?php endif; ?>
            ...
            <div class="cs-form-elem">
                <div class="cs-form-elem-content">
                    ...
                    <?php if (isset($loggedIn) && isset($entityAttributes) && isset($entityInfo)) : ?>
                        <span id="cs-form-info-span-email"><?php if ($loggedIn) {
                                                                echo $entityInfo[$entityAttributes["Email"]];
                                                            } ?></span>
                    <?php endif; ?>
