...
<div id="sh-main-body-div" class="text-font-700">
    ...
    <div id="sh-main-product-div" class="container text-font-300">
        <div id="sh-image-display-div">
            <img src="<?php echo  getImage('iCollar_white.png')?>" alt="iCollar">
        ...
        <div id="sh-info-div">
            ...
            <div id="sh-info-interaction-div">
                <div id="sh-interaction-amount" class="text-font-700">
                    <input id="sh-amount-input" class="sh-amount" type="text" value="1" max="100" min="1">
                    <div id="sh-amount-active" class="sh-amount">
                        <span>1</span>
                        <div>
                    ...
                    <div id="sh-amount-hidden" class="sh-amount text-font-700">
                        <ul>
                            <li>1</li>
                            <li>2</li>
                            <li>3</li>
