...
<body>
    ...
    <div id="mc-main-body-div" class="text-font-500">
        <lien><a href="profile.php">Compte</a>><a id="actif" href="">Messagerie</a></lien>
        <div>
    ...
    <script type="text/javascript">
        setMarginTop('site-header-main-header', 'id', 'mc-main-body-div', 'id', 40)
    </script>
